...
A Joget plugin for validating, compiling, and editing Rules Script definitions. Rules Script is a domain-specific language designed for defining eligibility rules in benefit programs, licensing, and similar eligibility use cases.
...
```text
# Agricultural benefit Eligibility Rules
...
- **Agricultural Subsidies** - Define applicant eligibility criteria
