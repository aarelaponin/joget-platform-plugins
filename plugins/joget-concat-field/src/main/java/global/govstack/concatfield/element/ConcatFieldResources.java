...
/**
 * Plugin for serving static resources (JS/CSS files) for the Concatenation Field element.
 * Implements PluginWebSupport to handle HTTP requests for static files.
 * 
 * Access via: /jw/web/json/plugin/global.govstack.concatfield.element.ConcatFieldResources/service?file=<filename>
 */
public class ConcatFieldResources extends ExtDefaultPlugin implements PluginWebSupport {

    private static final String CLASS_NAME = ConcatFieldResources.class.getName();

    public String getName() {
        return "Concatenation Field Resources";
    }
    ...
    public String getDescription() {
        return "Serves static resources for the Concatenation Field form element";
    }
